...
<div class="title span-18" >
            <h3 class="title">Admitted Terms</h3>
    ...
    <?php 
            $this->widget('bootstrap.widgets.TbMenu', array(
                    ...
                    'items'=>array(
                            ...
                            array('label'=>'Back', 'icon'=>'icon-arrow-left' , 'url'=>Yii::app()->controller->createUrl('termAdmission/index'), 'linkOptions'=>array('data-toggle'=>'tooltip','data-placement'=>'top', 'title'=>'Term Admission',), 'visible'=>true),	
                    ),
            ));
