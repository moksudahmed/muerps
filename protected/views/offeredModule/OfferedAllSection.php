...
<div class="title span-20">
            <h3 class="title">Offered Courses [All Sections]</h3>
            <h4><strong>Batch: </strong><span class="label label-success"> <?php echo yii::app()->session['batNameOfm'].FormUtil::getBatchNameSufix(yii::app()->session['batNameOfm']); ?>  </span><strong>Section: </strong><span class="label label-important"> All</span></h4>
...
<div class="span-18">
 ...
 $this->widget('bootstrap.widgets.TbButtonGroup', array(
    'buttons'=>array(
               array('label'=>'Not Offered', 'url'=>array('offeredModule/notOfferedAllSection'),'htmlOptions'=>array('class'=>'btn btn-medium ',)),
...
$this->widget('bootstrap.widgets.TbGroupGridView', array(
	...
	//'filter'=>$model,
        ...
        'extraRowExpression' => '"<b style=\"font-size: 20px; color: #333;\">".$data->sectionName."</b>"',
