...
<div id="form">
            ...
            <span class="label label-important">Preview</span>
    ...
    <div id="step1" class="preview">
                ...
                <strong>Employee Name: </strong><span class="label label-warning"><?php   echo CHtml::encode($person->per_title)." ".CHtml::encode($person->per_firstName)." ".CHtml::encode($person->per_lastName); ?>                   <?php echo $form->hiddenField( $person,'per_title'); ?></span>
...
<br/>
                    ...
                    <?php echo $form->hiddenField($person,'per_permanentAddress'); echo CHtml::hiddenField('presentAddress',$_REQUEST['presentAddress']); ?>
...
<br/>
        ...
        <div id="step2" class="preview">
            ...
            <h3>Official Details</h3>
                    ...
                    <strong>Joining Date: </strong><span class="label label-important"><?php echo CHtml::encode($employee->emp_joining); ?></span>
                    <?php echo $form->hiddenField($employee,'emp_joining'); ?>
                    
           
                    <strong>Designation: </strong><span class="label label-success"><?php echo CHtml::encode($employee->emp_designations); ?></span>
                    <?php echo $form->hiddenField($employee,'emp_designations'); ?>
           <br/>          
                    <strong>Supervisory Role: </strong><span class="label label-warning"><?php echo CHtml::encode($employee->emp_supervisoryRole); ?></span>
                    <?php echo $form->hiddenField($employee,'emp_supervisoryRole'); ?>
    ...
    <div id="step4">
    	...
    	<div>
            ...
            echo CHtml::hiddenField('flag', true);
              echo  CHtml::submitButton('Back', array('class' =>'btn btn-success btn-large'))." ".CHtml::button('Submit', array('class'=>'btn btn-danger btn-large', 'submit' => array('create', 'preview'=>2,'flag'=>true)));
