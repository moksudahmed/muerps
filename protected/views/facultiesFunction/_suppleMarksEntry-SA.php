...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<strong>Year:</strong><br/>
		...
		<?php  echo CHtml::radioButtonList('suppleType',(yii::app()->session['suppleType']?yii::app()->session['suppleType']:FormUtil::getSuppleExamType()) ,  ZHtml::enumItem('exm_supple_type'), array('labelOptions'=>array('style'=>'display:inline; font-size:20px; padding-right:10px'), 'separator'=>'  ','required'=>true));  ?>
