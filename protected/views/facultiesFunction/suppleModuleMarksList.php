...
/* @var $model Module */
            ...
            $this->breadcrumbs=array(
                ...
                FormUtil::getExamName( yii::app()->session['suppleType']).' Marks Entry'
                );
...
$secondHalfMarks= $markingScheme->mrs_final;
    ...
    <div class="title ">
        <div class="span-16">
            <h3 ><?php echo FormUtil::getExamName( yii::app()->session['suppleType']); ?> Marks Entry</h3>
        ...
        <div class="span-7">
            ...
            <h6>Programme:  <?php  echo DBhelper::getProgrammeByCode(yii::app()->session['suppleProCode']); ?></h6>
            <h6> <?php echo FormUtil::getTerm( yii::app()->session['suppleTerm']);?> <?php echo "Term Supplementary Examination ".yii::app()->session['suppleYear'];?></h6>
<?php 
                    ...
                    dataRaw.forEach((item) => {
                        ...
                        if (patt.test(dataCell[0])) {
                            ...
                            else
                            {
                                //console.log(i);
                                i++;
                                errLog[i]=[[dataCell[0]],[dataCell[1]]];
...
<table class="table table-bordered span-24">
	...
	<?php $serial=1; foreach($moduleReg as $row): ?>
                         <?php 
                                $reg= ModuleRegistration::model()->findByPk($row['moduleRegistrationID']); 
