...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    'action'=>CController::createUrl('facultiesFunction/GetRegisteredModuleForBatch'),
...
<div class="row ">
	...
	<strong>Term:</strong><br/>
		...
		<?php  echo CHtml::dropDownList('mreYear', (yii::app()->session['mreYear']?yii::app()->session['mreYear']:FormUtil::getYear()), FormUtil::yearForDropDown(2008), 
