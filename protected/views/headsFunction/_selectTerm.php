...
<div class="row">
                ...
                <div class="row">
                 <?php echo   CHtml::radioButtonList('ofmType',yii::app()->session['ofmType'] , array('0'=>'All Section','1'=>'Individual Section'), array('required'=>'true','labelOptions'=>array('style'=>'display:inline; padding-right:10px'), 'separator'=>'  ',)); ?>
                </div>
                <div class="row" >
