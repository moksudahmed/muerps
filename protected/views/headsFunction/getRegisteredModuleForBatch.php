...
?>
    ...
    <div class="title ">
		...
		<?php endif;?>
                ...
                <div class="row">
                        <strong>Marks Entry Type:</strong><br/>
                        <?php  echo CHtml::radioButtonList('mreType', (yii::app()->session['mreType']?yii::app()->session['mreType']:1) ,  array(1=>'Regular',2=>'Data Entry',), array('labelOptions'=>array('style'=>'display:inline; padding-right:10px'), 'separator'=>'  ',));  ?>
                </div >
                <div class="row" >
