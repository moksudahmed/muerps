...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'enableAjaxValidation'=>true,
        'action'=>CController::createUrl('offeredModule/offeredCourseList'),
)); ?>
	...
	<div class="row">
		...
		<?php echo CHtml::radioButtonList('ofmLiTerm',  (yii::app()->session['ofmLiTerm']?yii::app()->session['ofmLiTerm']:FormUtil::getCurrentTerm()),  ZHtml::$Terms, array('labelOptions'=>array('style'=>'display:inline; padding-right:10px; font-size:20px;'), 'separator'=>'  ',));  ?>
	
	</div>
    
    <div class="row">
	<strong>Year:</strong><br/>
		<?php  echo CHtml::dropDownList('ofmLiYear',  (yii::app()->session['ofmLiYear']?yii::app()->session['ofmLiYear']:FormUtil::getYear()), FormUtil::yearForDropDown(2010), 
