...
$total=0; 
               ...
               if(yii::app()->session['acYear']>=2015)
               {
                   $flag=TRUE;
                   if(yii::app()->session['acTerm']<3 && yii::app()->session['acYear']<=2015)
                   {
                       $flag = FALSE;
                   }
               }
   ...
   <thead>
       <tr>            
         ...
         <tr>
          ...
          ?>
          <tr>
            <th width="90%"><strong>VAT 7.5% (As per Government Law)</strong></th>
            <th width="20%" style="font-size:25px; text-align: left;"><strong><?php echo $vat;  ?></strong></th>
          </tr>    
          
         <tr>
            <th width="90%"><strong>Total Payable</strong></th>
            <th width="20%" style="font-size:25px; text-align: left;"><strong><?php echo $totalWithVAT;  ?></strong></th>
          </tr>    
        <?php
      //  $total = $totalWithVAT;
           }?>    
...
<br></br>
<table border="0"  style="font-size:19px;">
    ...
    <tr>
        <td width ="100%"><strong>
               ...
               if($flag==TRUE)
               {
                echo "* Tuttion Fees in 4 installments + VAT,taka: (".$instalment.'+'.$vatinstalment.')+'.'('.$instalment.'+'.$vatinstalment.')+'.'('.$instalment.'+'.$vatinstalment.')'.'+'.'('.$instalment.'+'.$vatinstalment.')'.'= '.$totalWithVAT;                
               }
               else
               {
                  echo "* Tuttion Fees in 4 installments,  taka: ".$instalment.' + '.$instalment.' + '.$instalment.' + '.$instalment.' = '.$total;                
               }
                ?> 
                </strong></td>
    </tr>
