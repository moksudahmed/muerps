...
$this->widget('bootstrap.widgets.TbButtonGroup', array(
    'buttons'=>array(
                ...
                array('label'=>'Advised Terms',  'url'=>array('allAdmittedTerms','flag'=>1),'htmlOptions'=>array('class'=>'btn btn-medium ',)),
                array('label'=>'Course Exemption', 'url'=>'#','htmlOptions'=>array('class'=>'btn btn-medium btn-danger',)),
                array('label'=>'Exempted Courses'.' ('.yii::app()->session['totalCourse'].')', 'url'=>array('ExepmtedCourses'),'htmlOptions'=>array('class'=>'btn btn-medium ',)),
            )
        )
     );
?>
	...
	//'filter'=>$model,
        ...
        'bulkActions' => array(
            ...
            array(
                ...
                'url' => array('selectExamptionModule'),
            'buttonType' => 'link',
            'type' => 'primary',
            'size' => 'large',
