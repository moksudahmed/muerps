...
/* @var $model ModuleRegistration */
    ...
    $this->breadcrumbs=array(
     ...
     'Transcript Index'=>array('examDepartment/index'),
...
$this->widget('bootstrap.widgets.TbMenu', array(
	'type'=>'pills',
	'items'=>array(
		array('label'=>'Personal Profile', 'icon'=>'icon-download', 'url'=>Yii::app()->controller->createUrl('student/studentProfile', array('id'=>yii::app()->session['trnsStudentID'])), 'linkOptions'=>array('target'=>'_blank'), 'visible'=>true),
