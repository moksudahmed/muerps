...
$this->widget('bootstrap.widgets.TbGroupGridView', array(
	...
	'columns'=>array(
                ...
                $groupGridColumns,
		//'moduleCode',
                array( 'name' => 'moduleCode',//'value' => '$data->mod_group',
                    'headerHtmlOptions' => array('style'=>'display:none'),
                    'htmlOptions' =>array('class'=>'span-3','style'=>'')
                ),
                'mod_shortName',
		array( 'name' => 'mod_name',//'value' => '$data->mod_group',
                    'headerHtmlOptions' => array('style'=>'display:none'),
                    'htmlOptions' =>array('class'=>'span-8','style'=>'')
                ),
		'mod_creditHour',
		'mod_type',
		'mod_labIncluded',
