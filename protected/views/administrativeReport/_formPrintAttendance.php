	...
	<div class="row">
		...
		<?php echo CHtml::dropDownList('programmeCode','programmeCode', CHtml::listData(FormUtil::getProgrammeByGroup(),
                   'programmeCode','pro_name','group'),array(
                    ...
                    'url'=>CController::createUrl('administrativeReport/getSection'), //url to call.
                    //Style: CController::createUrl('currentController/methodToCall')
                    'update'=>'#sectionName2', //selector to update
                    //'data'=>'js: $(this).val()' 
        ...
        <div class="row">
            ...
            <?php echo CHtml::dropDownList('sectionName2','sectionName2',array(),array(
