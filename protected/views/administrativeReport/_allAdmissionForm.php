...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    'action'=>CController::createUrl('reportAllAdmission'),
)); ?>
...
//        echo CHtml::hiddenField('caTerm', yii::app()->session['MainCurTerm']);
  //      echo CHtml::hiddenField('caYear', yii::app()->session['MainCurYear']);
	...
	<div class="row">
		...
		<?php echo CHtml::radioButtonList('reportTerm',  (yii::app()->session['adReTerm']?yii::app()->session['adReTerm']:FormUtil::getCurrentTerm()),  ZHtml::$Terms, array('labelOptions'=>array('style'=>'display:inline; font-size:20px; padding-right:10px'), 'separator'=>'  ',));  ?>
	
	</div>
    
        <div class="row">
	<strong>Year:</strong><br/>
		<?php  echo CHtml::dropDownList('reportYear',  (yii::app()->session['adReYear']?yii::app()->session['adReYear']:FormUtil::getYear()), FormUtil::yearForDropDown(2003), 
		...
		<?php echo CHtml::dropDownList('programmeCode',yii::app()->session['adReProCode'], CHtml::listData(FormUtil::getProgrammeByGroup(),
