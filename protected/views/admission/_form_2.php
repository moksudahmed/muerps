...
<br/> 
            ...
            <div class="row" >
                <?php echo $form->labelEx($admission,'waiverID'); ?>
                                 <?php echo $form->dropDownList($admission, 'waiverID', Chtml::listData(Waiver::model()->findAllBySql('SELECT * FROM tbl_ab_waiver where wav_active=true order by wav_title;'), 'waiverID', 'wav_title'), array('prompt' => '-- Please Select --','value' => '0','class'=>'span-10','style'=>'height:35px; font-size:20px;')); ?>
                            ...
                            <td>
                                <?php 
                                    ...
                                    $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                                        ...
                                        'value'=>$acHistory->ach_institution[0],
                            ...
                            <td>
                                <?php 
                                    $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                                       ...
                                       // 'source'=>array('111-115-001', '111-112-110', '111-112-100','211-115-001', '211-112-110','211-112-111', '311-112-100',),
                                        'value'=>$acHistory->ach_institution[1],
                            ...
                            <td>
                                <?php 
                                    $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                                       ...
                                       // 'source'=>array('111-115-001', '111-112-110', '111-112-100','211-115-001', '211-112-110','211-112-111', '311-112-100',),
                                        'value'=>$acHistory->ach_institution[2],
                            ...
                            <td>
                                <?php 
                                    $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                                       ...
                                       // 'source'=>array('111-115-001', '111-112-110', '111-112-100','211-115-001', '211-112-110','211-112-111', '311-112-100',),
                                        'value'=>$acHistory->ach_institution[3],
