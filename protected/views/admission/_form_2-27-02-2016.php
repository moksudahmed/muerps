                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo CHtml::textField('ach_institution[1]',$acHistory->ach_institution[1],array('class'=>'span-3','style'=>'height:25px; font-size:20px;')); ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo CHtml::textField('ach_institution[2]',$acHistory->ach_institution[2],array('class'=>'span-3','style'=>'height:25px; font-size:20px;')); ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo CHtml::textField('ach_institution[3]',$acHistory->ach_institution[3],array('class'=>'span-3','style'=>'height:25px; font-size:20px;')); ?></td>
