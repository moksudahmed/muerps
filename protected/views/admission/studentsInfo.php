...
{
    $panels = array(
            //'All in one'=>$this->renderPartial('_allInOne',null,true,true),
            ...
            'Course Exemption (Credit Transfer)'=>$this->renderPartial('_ExamptionForm',null,true,true),  
          ...
          //  'Term Admission'=>$this->renderPartial('_termAdmission',null,true,true),
            'Term Admission Batchwise'=>$this->renderPartial('_termAdmissionSuperAdv',null,true,true),
            ...
            'Obsolete Course Resgistration'=>$this->renderPartial('_formOldCourseRegistration',null,true,true),
