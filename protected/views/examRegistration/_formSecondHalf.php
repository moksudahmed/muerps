...
<?php $form = $this->beginWidget(
                        ...
                        ?>
                            ...
                            <?php 
                        echo CHtml::ajaxSubmitButton('Save', CController::createUrl('examRegistration/saveFinal'), array('update'=>'#inlineFormFinal'.$i),array('class'=>'btn btn btn-danger','style'=>'display:none;','data-toggle'=>'tooltip','title'=>'Save Marks','id'=>'save-'.$i,));
                        ?>
