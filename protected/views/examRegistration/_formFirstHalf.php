...
<?php $form = $this->beginWidget(
                        ...
                        echo CHtml::ajaxSubmitButton('Save', CController::createUrl('examRegistration/saveMarks'), array('update'=>'#inlineForm-'.$i),array('class'=>'btn btn btn-danger','style'=>'display:none;','data-toggle'=>'tooltip','title'=>'Save Marks','id'=>'save-'.$i,));
                        ?>
