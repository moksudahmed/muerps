...
$this->widget('bootstrap.widgets.TbMenu', array(
	'type'=>'pills',
	'items'=>array(
                array('label'=>'Back', 'icon'=>'icon-arrow-left' , 'url'=>Yii::app()->controller->createUrl('examRegistration/Supplementary'), 'linkOptions'=>array('data-toggle'=>'tooltip','data-placement'=>'top', 'title'=>'Supplementary',), 'visible'=>true),	
...
$this->widget('bootstrap.widgets.TbGroupGridView', array(
  ...
  //              'value' => $moduleName,
               ...
               /* array('name' => 'mod_group','header'=>'Group',
                ...
                array('name' => 'reg_date','header'=>'Reg Date',
                //'value' => '$data[\'moduleCode\']',
                'htmlOptions' =>array('class'=>'span-3','style'=>'',),'headerHtmlOptions' => array('style'=>''),
                ),
         ...
         'delete' => array
                (
                    'label'=>'Cancel Retake',
                    'icon'=>'remove white',
                    'url'=>'Yii::app()->createUrl("examRegistration/DeleteSuppleRegistration", array("id"=>$data[\'moduleRegistrationID\'],"eid"=>$data[\'examinationID\']))',
                    'options'=>array(
