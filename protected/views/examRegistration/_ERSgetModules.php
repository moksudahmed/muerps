...
?>
                ...
                <?php echo CHtml::dropDownList('offeredModuleID',yii::app()->session['mreOfmID'], 
                        CHtml::listData(FormUtil::getERSregisteredModules($ofmModule),'offeredModuleID','mod_name','mod_group')
                        ,array(
...
<br/>
                 ...
                 echo  CHtml::submitButton('Student Id', array('class'=>'btn btn-large btn-info','style'=>'',))."  ";
