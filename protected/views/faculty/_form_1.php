...
<span>Same As Permanent Address</span>                
 <?php 
 $_REQUEST['presentAddress'] ='';
 echo CHtml::checkBox('presentAddress',$_REQUEST['presentAddress'], array('value'=>1, 'uncheckValue'=>0)); ?>
<br/>                
        ...
        <div id="step2">
            ...
            <div class="row">
                    <?php echo $form->labelEx($faculty,'fac_joining'); ?>
                    <?php $this->widget('zii.widgets.jui.CJuiDatePicker',
                                    array(
                    ...
                    <?php echo $form->error($faculty,'fac_joining'); ?>
            </div>
            
            <div class="row">
                    <?php echo $form->labelEx($faculty,'fac_designation'); ?>
                    <?php echo ZHtml::enumActiveDropDownList( $faculty,'fac_designation'); ?>
                        
                    <?php echo $form->error($faculty,'fac_designation'); ?>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php
                            $_REQUEST['result'][0]='';
                            echo CHtml::checkBox('result[0]',$_REQUEST['result'][0], array('value'=>1, 'uncheckValue'=>0,'rel'=>'0','class'=>'result','title'=>'GPA/Division')); ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php
                            $_REQUEST['result'][1]='';
                            echo CHtml::checkBox('result[1]',$_REQUEST['result'][1], array('value'=>1, 'uncheckValue'=>0,'rel'=>'1','class'=>'result','title'=>'GPA/Division')); ?></td>
                          ...
                          <tr>
                           ...
                           <td><?php 
                            $_REQUEST['result'][2]='';
                           echo CHtml::checkBox('result[2]',$_REQUEST['result'][2], array('value'=>1, 'uncheckValue'=>0,'rel'=>'2','class'=>'result','title'=>'GPA/Division')); ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo CHtml::dropDownList('ach_group[3]',$acHistory->ach_group[0],  ZHtml::$Group, array('prompt' => '--Select Group--','value' => '0','style'=>'width:145px;')); ?></td>
                            <td><?php echo CHtml::dropDownList('ach_board[3]',$acHistory->ach_board[0], ZHtml::$Board, array('prompt' => '--Select Board--','value' => '0','style'=>'width:145px;')); ?></td>
                            ...
                            <td><?php 
                            $_REQUEST['result'][3]='';
                            echo CHtml::checkBox('result[3]',$_REQUEST['result'][3], array('value'=>1, 'uncheckValue'=>0,'rel'=>'3','class'=>'result','title'=>'GPA/Division')); ?></td>
