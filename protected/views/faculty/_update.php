...
<div class="row">
        ...
        <div id="step2">
            ...
            <div class="row">
                ...
                <div class="row">
                        <?php echo $form->labelEx($faculty,'fac_loginName'); ?>
                    <?php echo $form->textField($faculty,'fac_loginName'); ?>
                        <?php echo $form->error($faculty,'fac_loginName'); ?>
                </div>
            
            <div class="row">
                    <?php echo $form->labelEx($faculty,'fac_leave'); ?>
                    <?php $this->widget('zii.widgets.jui.CJuiDatePicker',
                                    array(
                                            'attribute'=>'fac_leave',
                                            'model'=>$faculty,
                    ...
                    <?php echo $form->error($faculty,'fac_leave'); ?>
            </div>
