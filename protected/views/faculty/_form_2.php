...
<br/>
        ...
        <div id="step2" class="preview">
            ...
            <h3>Official Details</h3>
                    ...
                    <strong>Joining Date: </strong><span class="label label-important"><?php echo CHtml::encode($faculty->fac_joining); ?></span>
                    <?php echo $form->hiddenField($faculty,'fac_joining'); ?>
                    
           
                    <strong>Designation: </strong><span class="label label-success"><?php echo CHtml::encode($faculty->fac_designation); ?></span>
                    <?php echo $form->hiddenField($faculty,'fac_designation'); ?>
           <br/>          
    ...
    <div id="step4">
    	...
    	<div>
            ...
            <?php $_REQUEST['HasPreDegree']='';
            echo CHtml::hiddenField('HasPreDegree', $_REQUEST['HasPreDegree']);
            echo CHtml::hiddenField('flag', true);
              echo  CHtml::submitButton('Back', array('class' =>'btn btn-success btn-large'))." ".CHtml::button('Submit', array('class'=>'btn btn-danger btn-large', 'submit' => array('create', 'preview'=>2,'flag'=>1)));
