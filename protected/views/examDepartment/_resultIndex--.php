...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<strong>Year:</strong><br/>
		...
		<?php  echo CHtml::radioButtonList('resultType',(yii::app()->session['reType']?yii::app()->session['reType']:1) ,  ZHtml::$ExamType, array('labelOptions'=>array('style'=>'display:inline; font-size:20px; padding-right:10px'), 'separator'=>'  ','required'=>true));  ?>
    ...
    <strong>Major Subject Name:</strong><br/>	
        ...
        <div class="row" >
            <strong>Please check the box for Thesis/Viva:</strong><br/>	
                <?php echo CHtml::checkBox("thesis");?>                      
	</div>
