...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    'action'=>CController::createUrl('examDepartment/PublishResult'),
)); ?>
	...
	<div class="row">
            ...
            <?php echo Chtml::hiddenField('rpTerm', yii::app()->session['MainCurTerm']); ?>
            <?php echo Chtml::hiddenField('rpYear', yii::app()->session['MainCurYear']); ?>
		...
		<?php echo CHtml::dropDownList('programmeCode',yii::app()->session['rpProCode'], CHtml::listData(FormUtil::getProgrammeByGroupByDepartmentID(yii::app()->session['MainDepartmentID']),
