...
class AcademicRecordPDF extends TCPDF {
        
    public $text = 'Academic Record';
    ...
    public function Header() 
    {
           ...
           // $this->Cell(0, 15, 'Tabulation Sheet', 0, false, 'L', 0, '', 0, false, 'M', 'M');
            ...
            //$txt = 'Result Sheet';
            // Multicell test
            $this->MultiCell(100, 10, $this->text, 0, 'L', 0, 1, 70,10, true);
           ...
           $this->MultiCell(180, 10, FormUtil::getTermNumberWithSufix(yii::app()->session['reBatName'], yii::app()->session['reProCode'], yii::app()->session['reTerm'], yii::app()->session['reYear']) , 0, 'L', 0, 1, 140,15, true);
            $this->MultiCell(100, 10, 'Batch No: '.yii::app()->session['reBatName'].FormUtil::getBatchNameSufix1(yii::app()->session['reBatName']).'          '.'Academic Year: '.FormUtil::getTerm(yii::app()->session['reAcTerm']).' '.yii::app()->session['reAcYear'], 0, 'L', 0, 1, 140,20,true);
    ...
    // Page footer
     public function Footer() 
     {
        ...
        // Page number
        $this->Cell(0, 5, 'Note: This is a draft academic record. It is not an official document without authorized seal & signature.', 0, false, 'C', 0, '', 0, false, 'T', 'M');
