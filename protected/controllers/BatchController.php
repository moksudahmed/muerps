...
class BatchController extends Controller
{
                ...
                // Uncomment the following line if AJAX validation is needed
                   ...
                   $sql="SELECT 
                    ...
                    if(isset($_POST['Batch']))
                    {
                        ...
                        $batch = Batch::model()->findByAttributes(['bat_term'=>$model->bat_term,'bat_year'=>$model->bat_year,'programmeCode'=>$model->programmeCode]);  	 
	...
	public function actionUpdate($id,$pid)
	{
		...
		// $this->performAjaxValidation($model);
                ...
                $sql2="
                 ...
                 $sql3 ="SELECT distinct concat( sp_get_term_name(aa.\"fee_startTerm\"),' ',aa.\"fee_startYear\",' onward') as \"feesTitle\",
                            concat( aa.\"fee_startTerm\",' ',aa.\"fee_startYear\",' onward') as \"feesName\" 
                            FROM tbl_aa_fees aa, tbl_ac_batchfees ac WHERE
                            aa.\"feesID\"= ac.\"feesID\" and
                            ac.\"programmeCode\" = '{$model->programmeCode}' and 
                            ac.\"batchName\" = {$model->batchName}";
                 
                 $fees3= Fees::model()->findBySql($sql3);
                         
                (count([$fees3])?$model->feesName= $fees3->feesTitle:$model->feesName=null);
                ...
                if(isset($_POST['Batch']))
		{
			$model->attributes=$_POST['Batch'];
                        ...
                        //echo "test". $model->batchName. $model->programmeCode .$model->feesName ;
                        ...
                        //exit();
                                ...
                                if($model->update())
                                {
                                    if($flag)
                                    {
                                        $sqlDelete ="DELETE FROM tbl_ac_batchfees 
                                            WHERE \"batchName\"={$model->batchName} and \"programmeCode\"='{$model->programmeCode}'";
                                        ...
                                        Yii::app()->user->setFlash('success','Batch Updatation Successfully!!');
                                        $this->redirect(array('view','id'=>$model->batchName,'pid'=>$model->programmeCode));
                                ...
                                {
                                        Yii::app()->user->setFlash('warning','Batch Update Failure!!');
                                        $this->redirect(array('index'));
                                }
		}
	...
	public function loadModel($id,$pid)
	{
		$model=Batch::model()->findByPk(array('batchName'=>$id,'programmeCode'=>$pid));
                ...
                (isset($fees3)?$model->feesName= $fees3->feesTitle:$model->feesName=null);
