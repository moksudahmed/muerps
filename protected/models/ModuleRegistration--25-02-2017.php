...
// exit();
    ...
    public static function searchOfferedModule($studentID,$traTerm,$traYear,$programmeCode)
    {
       ...
       $sql="SELECT DISTINCT s.* FROM 
        (Select * from tbl_h_offeredmodule as o join tbl_e_module as m on(o.\"moduleCode\"=m.\"moduleCode\" and o.\"syllabusCode\"=m.\"syllabusCode\") where     o.ofm_term={$traTerm} and o.ofm_year={$traYear} ) as s 
        WHERE (\"offeredModuleID\") NOT IN
   ...
   //, sp_retakeflaglg('{$studentID}',s.\"offeredModuleID\") as \"retakeLetterGrade\"       
        ...
        public static function searchSuppleCourseByStudentID($studentID,$examinationID)
	{
